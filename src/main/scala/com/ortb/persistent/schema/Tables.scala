...
/** Slick data model trait for extension, choice of backend or usage in the cake pattern. (Make sure to initialize
 * this late.) */
trait Tables {

  /** DDL for all tables. Call .create to execute. */
  lazy val schema : profile.SchemaDescription = Array(
    Advertise.schema, Auction.schema, Banneradvertisetype.schema, Bidrequest.schema, Bidresponse.schema,
    Campaign.schema, Campaigntargetcity.schema, Campaigntargetoperatingsystem.schema, Campaigntargetsite.schema,
    Contentcategory.schema, Contentcontext.schema, Demandsideplatform.schema, Geomapping.schema, Impression.schema,
    Keyword.schema, Keywordadvertisemapping.schema, Lostbid.schema, Nobidresponsetype.schema, Publisher.schema,
    Transaction.schema).reduceLeft(_ ++ _)

  import profile.api._
  import slick.model.ForeignKeyAction
  // NOTE: GetResult mappers for plain SQL are only generated for tables where Slick knows how to map the types of
  // all columns.
  ...
  implicit def GetResultAdvertiseRow(
    implicit e0 : GR[Int], e1 : GR[String], e2 : GR[Option[String]], e3 : GR[Double],
    e4          : GR[Option[Int]]) : GR[AdvertiseRow] = GR {
    prs =>
      import prs._
      AdvertiseRow.tupled(
        (<<[Int], <<[Int], <<[Int], <<[String], <<[Int], <<[String], <<?[String], <<[Int], <<[Int], <<[Int],
  ...
  implicit def GetResultAuctionRow(
    implicit e0 : GR[Int], e1 : GR[Double], e2 : GR[Option[Int]], e3 : GR[String]) : GR[AuctionRow] = GR {
    prs =>
      import prs._
  ...
  implicit def GetResultBidrequestRow(
    implicit e0 : GR[Int], e1 : GR[Option[Int]], e2 : GR[Option[String]],
    e3          : GR[Option[Double]]) : GR[BidrequestRow] = GR {
    prs =>
      import prs._
      BidrequestRow.tupled(
        (<<[Int], <<[Int], <<?[Int], <<[Int], <<[Int], <<?[Int], <<?[Int], <<?[String], <<?[String], <<?[String],
          <<?[String], <<?[String], <<?[Double], <<?[Double], <<?[Double], <<?[String], <<?[Int], <<[Int]))
  }
  ...
  implicit def GetResultBidresponseRow(
    implicit e0 : GR[Int], e1 : GR[Double], e2 : GR[String], e3 : GR[Option[String]],
    e4          : GR[Option[Int]]) : GR[BidresponseRow] = GR {
    prs =>
      import prs._
      BidresponseRow.tupled(
        (<<[Int], <<[Double], <<[String], <<?[String], <<[String], <<?[String], <<[Int], <<?[Int], <<[Int], <<[Int],
          <<[Int], <<[Int], <<?[Int]))
  }
  ...
  implicit def GetResultCampaignRow(
    implicit e0 : GR[Int], e1 : GR[String], e2 : GR[Double], e3 : GR[Option[Double]], e4 : GR[Option[String]],
    e5          : GR[Option[Int]]) : GR[CampaignRow] = GR {
    prs =>
      import prs._
      CampaignRow.tupled(
        (<<[Int], <<[String], <<[String], <<[Double], <<[Double], <<[Double], <<?[Double], <<?[Double], <<[Int],
  ...
  case class AdvertiseRow(
    advertiseid       : Int, campaignid : Int, banneradvertisetypeid : Int, advertisetitle : String,
    contentcontextid  : Int, bidurl : String, iframehtml : Option[String], iscountryspecific : Int = 0,
    isvideo           : Int = 0, impressioncount : Int = 0, height : Double = 0.0, weight : Double = 0.0,
    minheight         : Double = 0.0, minweight : Double = 0.0, maxheight : Double = 0.0, maxweight : Double = 0.0,
    hasagerestriction : Int, minage : Option[Int] = Some(0), maxage : Option[Int] = Some(0))
  ...
  class Advertise(_tableTag : Tag) extends profile.api.Table[AdvertiseRow](_tableTag, "Advertise") {
    ...
    lazy val banneradvertisetypeFk = foreignKey("BannerAdvertiseType_FK_1", banneradvertisetypeid, Banneradvertisetype)(
      r => r.banneradvertisetypeid, onUpdate = ForeignKeyAction.Cascade, onDelete = ForeignKeyAction.Cascade)
    /** Foreign key referencing Campaign (database name Campaign_FK_2) */
    lazy val campaignFk            = foreignKey("Campaign_FK_2", campaignid, Campaign)(
      r => r.campaignid, onUpdate = ForeignKeyAction.Cascade, onDelete = ForeignKeyAction.Cascade)
    /** Foreign key referencing Contentcontext (database name ContentContext_FK_3) */
    lazy val contentcontextFk      = foreignKey("ContentContext_FK_3", contentcontextid, Contentcontext)(
      r => r.contentcontextid, onUpdate = ForeignKeyAction.Cascade, onDelete = ForeignKeyAction.Cascade)
    ...
    val iscountryspecific     : Rep[Int]            = column[Int](
      "IsCountrySpecific", O.Length(1, varying = false), O.Default(0))
    ...
    def * = (advertiseid, campaignid, banneradvertisetypeid, advertisetitle, contentcontextid, bidurl, iframehtml,
      iscountryspecific, isvideo, impressioncount, height, weight, minheight, minweight, maxheight, maxweight,
      hasagerestriction, minage, maxage) <> (AdvertiseRow.tupled, AdvertiseRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(advertiseid), Rep.Some(campaignid), Rep.Some(banneradvertisetypeid), Rep.Some(
      advertisetitle), Rep.Some(contentcontextid), Rep.Some(bidurl), iframehtml, Rep.Some(iscountryspecific), Rep.Some(
      isvideo), Rep.Some(impressioncount), Rep.Some(height), Rep.Some(weight), Rep.Some(minheight), Rep.Some(
      minweight), Rep.Some(maxheight), Rep.Some(maxweight), Rep.Some(hasagerestriction), minage, maxage)).shaped.<>(
      { r => import r._; _1.map(_ => AdvertiseRow.tupled(
        (_1.get, _2.get, _3.get, _4.get, _5.get, _6.get, _7, _8.get, _9.get, _10.get, _11.get, _12.get, _13.get,
          _14.get, _15.get, _16.get, _17.get, _18, _19)))
      }, (_ : Any) => throw new Exception("Inserting into ? projection not supported."))
  }

  /** GetResult implicit for fetching CampaigntargetoperatingsystemRow objects using plain SQL queries */
  implicit def GetResultCampaigntargetoperatingsystemRow(
    implicit e0 : GR[Int], e1 : GR[String]) : GR[CampaigntargetoperatingsystemRow] = GR {
    prs =>
      import prs._
   ...
   * @param isprecachedadvertiseserved Database column IsPrecachedAdvertiseServed SqlType(INTEGER), Length(1,false),
   *                                   Default(0)
  ...
  case class AuctionRow(
    auctionid                  : Int, advertiseid : Int, dated : Double, winningbidderid : Option[Int],
    isprecachedadvertiseserved : Int = 0, winningprice : Double = -1.0, currency : String)
  ...
  class Auction(_tableTag : Tag) extends profile.api.Table[AuctionRow](_tableTag, "Auction") {
    ...
    lazy val advertiseFk  = foreignKey("Advertise_FK_1", advertiseid, Advertise)(
      r => r.advertiseid, onUpdate = ForeignKeyAction.NoAction, onDelete = ForeignKeyAction.NoAction)
    /** Foreign key referencing Bidrequest (database name BidRequest_FK_2) */
    lazy val bidrequestFk = foreignKey("BidRequest_FK_2", winningbidderid, Bidrequest)(
      r => Rep.Some(r.bidrequestid), onUpdate = ForeignKeyAction.NoAction, onDelete = ForeignKeyAction.NoAction)
    ...
    val isprecachedadvertiseserved : Rep[Int]         = column[Int](
      "IsPrecachedAdvertiseServed", O.Length(1, varying = false), O.Default(0))
    ...
    def * = (auctionid, advertiseid, dated, winningbidderid, isprecachedadvertiseserved, winningprice, currency) <>
      (AuctionRow.tupled, AuctionRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(auctionid), Rep.Some(advertiseid), Rep.Some(dated), winningbidderid, Rep.Some(
      isprecachedadvertiseserved), Rep.Some(winningprice), Rep.Some(currency))).shaped.<>(
      { r => import r._; _1.map(_ => AuctionRow.tupled((_1.get, _2.get, _3.get, _4, _5.get, _6.get, _7.get))) },
                                                                                                               (_
 : Any) => throw new Exception(
  ...
  class Banneradvertisetype(_tableTag : Tag) extends profile.api.Table[BanneradvertisetypeRow](
    _tableTag, "BannerAdvertiseType") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(banneradvertisetypeid), Rep.Some(typename))).shaped.<>(
      { r => import r._; _1.map(_ => BanneradvertisetypeRow.tupled((_1.get, _2.get))) },
                                                                                       (_ : Any) => throw new Exception(
                                                                                         "Inserting into ? projection" +
                                                                                           " not supported."))
  }
  ...
  case class BidrequestRow(
    bidrequestid    : Int, demandsideplatformid : Int, auctionid : Option[Int], isbanner : Int = 0, isvideo : Int = 0,
    height          : Option[Int], width : Option[Int], countries : Option[String], cities : Option[String],
    targetedsites   : Option[String], targetedcities : Option[String], rawbidrequest : Option[String],
    price1          : Option[Double] = Some(0.0), price2 : Option[Double] = Some(0.0),
    price3          : Option[Double] = Some(0.0), currency : Option[String], contentcontextid : Option[Int],
    iswontheauction : Int = 0)
  ...
  class Bidrequest(_tableTag : Tag) extends profile.api.Table[BidrequestRow](_tableTag, "BidRequest") {
    ...
    lazy val auctionFk            = foreignKey("Auction_FK_1", auctionid, Auction)(
      r => Rep.Some(r.auctionid), onUpdate = ForeignKeyAction.NoAction, onDelete = ForeignKeyAction.NoAction)
    /** Foreign key referencing Contentcontext (database name ContentContext_FK_2) */
    lazy val contentcontextFk     = foreignKey("ContentContext_FK_2", contentcontextid, Contentcontext)(
      r => Rep.Some(r.contentcontextid), onUpdate = ForeignKeyAction.NoAction, onDelete = ForeignKeyAction.NoAction)
    /** Foreign key referencing Demandsideplatform (database name DemandSidePlatform_FK_3) */
    lazy val demandsideplatformFk = foreignKey("DemandSidePlatform_FK_3", demandsideplatformid, Demandsideplatform)(
      r => r.demandsideplatformid, onUpdate = ForeignKeyAction.NoAction, onDelete = ForeignKeyAction.NoAction)
    ...
    val iswontheauction      : Rep[Int]            = column[Int](
      "IsWonTheAuction", O.Length(1, varying = false), O.Default(0))

    def * = (bidrequestid, demandsideplatformid, auctionid, isbanner, isvideo, height, width, countries, cities,
      targetedsites, targetedcities, rawbidrequest, price1, price2, price3, currency, contentcontextid,
      iswontheauction) <> (BidrequestRow.tupled, BidrequestRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(bidrequestid), Rep.Some(demandsideplatformid), auctionid, Rep.Some(isbanner), Rep.Some(
      isvideo), height, width, countries, cities, targetedsites, targetedcities, rawbidrequest, price1, price2,
      price3, currency, contentcontextid, Rep.Some(
      iswontheauction))).shaped.<>(
      { r => import r._; _1.map(_ => BidrequestRow.tupled(
        (_1.get, _2.get, _3, _4.get, _5.get, _6, _7, _8, _9, _10, _11, _12, _13, _14, _15, _16, _17, _18.get)))
      }, (_ : Any) => throw new Exception("Inserting into ? projection not supported."))
  }
  ...
  case class BidresponseRow(
    bidresponseid        : Int, price : Double, currency : String, adm : Option[String], nurl : String,
    iurl                 : Option[String], advertiseid : Int, bidrequestid : Option[Int], iswontheauction : Int = 0,
    isauctionoccured     : Int = 0, isprecachedbidserved : Int = 0, issendnobidresponse : Int = 0,
    nobidresponsetypeid  : Option[Int])
  ...
  class Bidresponse(_tableTag : Tag) extends profile.api.Table[BidresponseRow](_tableTag, "BidResponse") {
    /** Foreign key referencing Advertise (database name Advertise_FK_1) */
    lazy val advertiseFk         = foreignKey("Advertise_FK_1", advertiseid, Advertise)(
      r => r.advertiseid, onUpdate = ForeignKeyAction.Cascade, onDelete = ForeignKeyAction.Cascade)
    /** Foreign key referencing Bidrequest (database name BidRequest_FK_2) */
    lazy val bidrequestFk        = foreignKey("BidRequest_FK_2", bidrequestid, Bidrequest)(
      r => Rep.Some(r.bidrequestid), onUpdate = ForeignKeyAction.NoAction, onDelete = ForeignKeyAction.NoAction)
    /** Foreign key referencing Nobidresponsetype (database name NoBidResponseType_FK_3) */
    lazy val nobidresponsetypeFk = foreignKey("NoBidResponseType_FK_3", nobidresponsetypeid, Nobidresponsetype)(
      r => Rep.Some(r.nobidresponsetypeid), onUpdate = ForeignKeyAction.NoAction, onDelete = ForeignKeyAction.NoAction)
    ...
    val isauctionoccured     : Rep[Int]            = column[Int](
      "IsAuctionOccured", O.Length(1, varying = false), O.Default(0))
    /** Database column IsPreCachedBidServed SqlType(INTEGER), Length(1,false), Default(0) */
    val isprecachedbidserved : Rep[Int]            = column[Int](
      "IsPreCachedBidServed", O.Length(1, varying = false), O.Default(0))
    /** Database column IsSendNoBidResponse SqlType(INTEGER), Length(1,false), Default(0) */
    val issendnobidresponse  : Rep[Int]            = column[Int](
      "IsSendNoBidResponse", O.Length(1, varying = false), O.Default(0))
    ...
    def * = (bidresponseid, price, currency, adm, nurl, iurl, advertiseid, bidrequestid, iswontheauction,
      isauctionoccured, isprecachedbidserved, issendnobidresponse, nobidresponsetypeid) <> (BidresponseRow.tupled,
      BidresponseRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(bidresponseid), Rep.Some(price), Rep.Some(currency), adm, Rep.Some(nurl), iurl, Rep.Some(
      advertiseid), bidrequestid, Rep.Some(iswontheauction), Rep.Some(isauctionoccured), Rep.Some(
      isprecachedbidserved), Rep.Some(issendnobidresponse), nobidresponsetypeid)).shaped.<>(
      { r => import r._; _1.map(_ => BidresponseRow.tupled(
        (_1.get, _2.get, _3.get, _4, _5.get, _6, _7.get, _8, _9.get, _10.get, _11.get, _12.get, _13)))
      }, (_ : Any) => throw new Exception("Inserting into ? projection not supported."))
  }
  ...
  case class CampaignRow(
    campaignid   : Int, campaignname : String, contentcategoryid : String, totalbudgetcpm : Double = 0.0,
    spendalready : Double = 0.0, remainingamount : Double = 0.0, startdate : Option[Double] = Some(0.0),
    enddate      : Option[Double] = Some(0.0), impressioncount : Int = 0, demandsideplatformid : Int,
    isrunning    : Int = 0, priority : Int = 999, isretricttousergender : Int = 0, expectedusergender : Option[String],
  ...
  class Campaign(_tableTag : Tag) extends profile.api.Table[CampaignRow](_tableTag, "Campaign") {
    ...
    lazy val contentcategoryFk    = foreignKey("ContentCategory_FK_1", contentcategoryid, Contentcategory)(
      r => r.contentcategoryid, onUpdate = ForeignKeyAction.NoAction, onDelete = ForeignKeyAction.NoAction)
    /** Foreign key referencing Demandsideplatform (database name DemandSidePlatform_FK_2) */
    lazy val demandsideplatformFk = foreignKey("DemandSidePlatform_FK_2", demandsideplatformid, Demandsideplatform)(
      r => r.demandsideplatformid, onUpdate = ForeignKeyAction.Cascade, onDelete = ForeignKeyAction.Cascade)
    /** Foreign key referencing Publisher (database name Publisher_FK_3) */
    lazy val publisherFk          = foreignKey("Publisher_FK_3", publisherid, Publisher)(
      r => Rep.Some(r.publisherid), onUpdate = ForeignKeyAction.SetNull, onDelete = ForeignKeyAction.SetNull)
    ...
    val isrunning             : Rep[Int]            = column[Int](
      "IsRunning", O.Length(1, varying = false), O.Default(0))
    /** Database column Priority SqlType(INTEGER), Length(3,false), Default(999) */
    val priority              : Rep[Int]            = column[Int](
      "Priority", O.Length(3, varying = false), O.Default(999))
    /** Database column IsRetrictToUserGender SqlType(INTEGER), Length(1,false), Default(0) */
    val isretricttousergender : Rep[Int]            = column[Int](
      "IsRetrictToUserGender", O.Length(1, varying = false), O.Default(0))
    /** Database column ExpectedUserGender SqlType(TEXT), Length(2,false) */
    val expectedusergender    : Rep[Option[String]] = column[Option[String]](
      "ExpectedUserGender", O.Length(2, varying = false))
    /** Database column PublisherId SqlType(INTEGER) */
    val publisherid           : Rep[Option[Int]]    = column[Option[Int]]("PublisherId")

    def * = (campaignid, campaignname, contentcategoryid, totalbudgetcpm, spendalready, remainingamount, startdate,
      enddate, impressioncount, demandsideplatformid, isrunning, priority, isretricttousergender, expectedusergender,
      publisherid) <> (CampaignRow.tupled, CampaignRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(campaignid), Rep.Some(campaignname), Rep.Some(contentcategoryid), Rep.Some(
      totalbudgetcpm), Rep.Some(spendalready), Rep.Some(remainingamount), startdate, enddate, Rep.Some(
      impressioncount), Rep.Some(demandsideplatformid), Rep.Some(isrunning), Rep.Some(priority), Rep.Some(
      isretricttousergender), expectedusergender, publisherid)).shaped.<>(
      { r => import r._; _1.map(_ => CampaignRow.tupled(
        (_1.get, _2.get, _3.get, _4.get, _5.get, _6.get, _7, _8, _9.get, _10.get, _11.get, _12.get, _13.get, _14, _15)))
      }, (_ : Any) => throw new Exception("Inserting into ? projection not supported."))
  }
  ...
  class Campaigntargetcity(_tableTag : Tag) extends profile.api.Table[CampaigntargetcityRow](
    _tableTag, "CampaignTargetCity") {
    /** Foreign key referencing Campaign (database name Campaign_FK_1) */
    lazy val campaignFk = foreignKey("Campaign_FK_1", campaignid, Campaign)(
      r => r.campaignid, onUpdate = ForeignKeyAction.Cascade, onDelete = ForeignKeyAction.Cascade)
    ...
    def * = (campaigntargetcityid, campaigntargetcity, campaignid) <> (CampaigntargetcityRow.tupled,
      CampaigntargetcityRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(campaigntargetcityid), Rep.Some(campaigntargetcity), Rep.Some(campaignid))).shaped.<>(
      { r => import r._; _1.map(_ => CampaigntargetcityRow.tupled((_1.get, _2.get, _3.get))) },
                                                                                              (_ : Any) => throw new
                                                                                                  Exception(
                                                                                                "Inserting into ? " +
                                                                                                  "projection not " +
   ...
   *
   * @param campaigntargetoperatingsystemid Database column CampaignTargetOperatingSystemId SqlType(INTEGER),
   *                                        AutoInc, PrimaryKey
   * @param campaigntargetoperatingsystem   Database column CampaignTargetOperatingSystem SqlType(TEXT)
   * @param campaignid                      Database column CampaignId SqlType(INTEGER) */
  case class CampaigntargetoperatingsystemRow(
    campaigntargetoperatingsystemid : Int, campaigntargetoperatingsystem : String, campaignid : Int)

  /** Table description of table CampaignTargetOperatingSystem. Objects of this class serve as prototypes for rows in
   *  queries. */
  class Campaigntargetoperatingsystem(_tableTag : Tag) extends profile.api.Table[CampaigntargetoperatingsystemRow](
    _tableTag, "CampaignTargetOperatingSystem") {
    /** Foreign key referencing Campaign (database name Campaign_FK_1) */
    lazy val campaignFk = foreignKey("Campaign_FK_1", campaignid, Campaign)(
      r => r.campaignid, onUpdate = ForeignKeyAction.Cascade, onDelete = ForeignKeyAction.Cascade)
    /** Database column CampaignTargetOperatingSystemId SqlType(INTEGER), AutoInc, PrimaryKey */
    val campaigntargetoperatingsystemid : Rep[Int]    = column[Int](
      "CampaignTargetOperatingSystemId", O.AutoInc, O.PrimaryKey)
    ...
    def * = (campaigntargetoperatingsystemid, campaigntargetoperatingsystem, campaignid) <>
      (CampaigntargetoperatingsystemRow.tupled, CampaigntargetoperatingsystemRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(campaigntargetoperatingsystemid), Rep.Some(campaigntargetoperatingsystem), Rep.Some(
      campaignid))).shaped.<>(
      { r => import r._; _1.map(_ => CampaigntargetoperatingsystemRow.tupled((_1.get, _2.get, _3.get))) },
                                                                                                         (_ : Any) =>
                                                                                                           throw new
                                                                                                               Exception(
                                                                                                           "Inserting" +
  ...
  implicit def GetResultGeomappingRow(
    implicit e0 : GR[Int], e1 : GR[String], e2 : GR[Option[String]]) : GR[GeomappingRow] = GR {
    prs =>
      import prs._
  ...
  class Campaigntargetsite(_tableTag : Tag) extends profile.api.Table[CampaigntargetsiteRow](
    _tableTag, "CampaignTargetSite") {
    /** Foreign key referencing Campaign (database name Campaign_FK_1) */
    lazy val campaignFk = foreignKey("Campaign_FK_1", campaignid, Campaign)(
      r => r.campaignid, onUpdate = ForeignKeyAction.Cascade, onDelete = ForeignKeyAction.Cascade)
    ...
    def * = (campaigntargetsiteid, campaigntargetsite, campaignid) <> (CampaigntargetsiteRow.tupled,
      CampaigntargetsiteRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(campaigntargetsiteid), Rep.Some(campaigntargetsite), Rep.Some(campaignid))).shaped.<>(
      { r => import r._; _1.map(_ => CampaigntargetsiteRow.tupled((_1.get, _2.get, _3.get))) },
                                                                                              (_ : Any) => throw new
                                                                                                  Exception(
                                                                                                "Inserting into ? " +
                                                                                                  "projection not " +
  ...
  class Contentcategory(_tableTag : Tag) extends profile.api.Table[ContentcategoryRow](_tableTag, "ContentCategory") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(contentcategoryid), Rep.Some(contentcategoryname))).shaped.<>(
      { r => import r._; _1.map(_ => ContentcategoryRow.tupled((_1.get, _2.get))) }, (_ : Any) => throw new Exception(
        "Inserting into ? projection not supported."))
  }
  ...
  implicit def GetResultImpressionRow(implicit e0 : GR[Int], e1 : GR[Double], e2 : GR[String]) : GR[ImpressionRow] = GR
                                                                                                                     {
                                                                                                                       prs =>
                                                                                                                         import prs._
                                                                                                                         ImpressionRow.tupled(
                                                                                                                           (<<[Int], <<[Int], <<[Int], <<[Int], <<[Double], <<[String]))
                                                                                                                     }
  ...
  class Contentcontext(_tableTag : Tag) extends profile.api.Table[ContentcontextRow](_tableTag, "ContentContext") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(contentcontextid), Rep.Some(context))).shaped.<>(
      { r => import r._; _1.map(_ => ContentcontextRow.tupled((_1.get, _2.get))) }, (_ : Any) => throw new Exception(
        "Inserting into ? projection not supported."))
  }
  ...
  class Demandsideplatform(_tableTag : Tag) extends profile.api.Table[DemandsideplatformRow](
    _tableTag, "DemandSidePlatform") {
    ...
    def * = (demandsideplatformid, demandsideplatformname) <> (DemandsideplatformRow.tupled, DemandsideplatformRow
      .unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(demandsideplatformid), Rep.Some(demandsideplatformname))).shaped.<>(
      { r => import r._; _1.map(_ => DemandsideplatformRow.tupled((_1.get, _2.get))) },
                                                                                      (_ : Any) => throw new Exception(
                                                                                        "Inserting into ? projection " +
                                                                                          "not supported."))
  }
  ...
  case class GeomappingRow(
    geomappingid : Int, advertiseid : Int, country : String, hascity : Int = 0, city : Option[String] = None)
  ...
  class Geomapping(_tableTag : Tag) extends profile.api.Table[GeomappingRow](_tableTag, "GeoMapping") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(geomappingid), Rep.Some(advertiseid), Rep.Some(country), Rep.Some(hascity), city)).shaped.<>(
      { r => import r._; _1.map(_ => GeomappingRow.tupled((_1.get, _2.get, _3.get, _4.get, _5))) },
                                                                                                  (_ : Any) => throw
                                                                                                    new Exception(
                                                                                                    "Inserting into ?" +
                                                                                                      " projection " +
   ...
   * @param price        Database column Price SqlType(REAL)
   * @param currency     Database column Currency SqlType(TEXT) */
  case class ImpressionRow(
    impressionid : Int, advertiseid : Int, dated : Int, bidrequestid : Int, price : Double, currency : String)
  ...
  class Impression(_tableTag : Tag) extends profile.api.Table[ImpressionRow](_tableTag, "Impression") {
    ...
    def * = (impressionid, advertiseid, dated, bidrequestid, price, currency) <> (ImpressionRow.tupled, ImpressionRow
      .unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(impressionid), Rep.Some(advertiseid), Rep.Some(dated), Rep.Some(bidrequestid), Rep.Some(
      price), Rep.Some(currency))).shaped.<>(
      { r => import r._; _1.map(_ => ImpressionRow.tupled((_1.get, _2.get, _3.get, _4.get, _5.get, _6.get))) },
                                                                                                              (_
 : Any) => throw new Exception(
                                                                                                                "Inserting into ? projection not supported."))
  }
  ...
  class Keyword(_tableTag : Tag) extends profile.api.Table[KeywordRow](_tableTag, "Keyword") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(keywordid), keyword)).shaped.<>(
      { r => import r._; _1.map(_ => KeywordRow.tupled((_1.get, _2))) }, (_ : Any) => throw new Exception(
        "Inserting into ? projection not supported."))
  }
  ...
  /** Table description of table KeywordAdvertiseMapping. Objects of this class serve as prototypes for rows in
   * queries. */
  class Keywordadvertisemapping(_tableTag : Tag) extends profile.api.Table[KeywordadvertisemappingRow](
    _tableTag, "KeywordAdvertiseMapping") {
    /** Foreign key referencing Advertise (database name Advertise_FK_1) */
    lazy val advertiseFk = foreignKey("Advertise_FK_1", advertiseid, Advertise)(
      r => r.advertiseid, onUpdate = ForeignKeyAction.NoAction, onDelete = ForeignKeyAction.NoAction)
    /** Foreign key referencing Keyword (database name Keyword_FK_2) */
    lazy val keywordFk   = foreignKey("Keyword_FK_2", keywordid, Keyword)(
      r => r.keywordid, onUpdate = ForeignKeyAction.Cascade, onDelete = ForeignKeyAction.Cascade)
    ...
    def * = (keywordadvertisemappingid, advertiseid, keywordid) <> (KeywordadvertisemappingRow.tupled,
      KeywordadvertisemappingRow.unapply)

    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(keywordadvertisemappingid), Rep.Some(advertiseid), Rep.Some(keywordid))).shaped.<>(
      { r => import r._; _1.map(_ => KeywordadvertisemappingRow.tupled((_1.get, _2.get, _3.get))) },
                                                                                                   (_ : Any) => throw
                                                                                                     new Exception(
                                                                                                     "Inserting into " +
                                                                                                       "? projection " +
  ...
  implicit def GetResultNobidresponsetypeRow(
    implicit e0 : GR[Int], e1 : GR[Option[String]]) : GR[NobidresponsetypeRow] = GR {
    prs =>
      import prs._
  ...
  class Lostbid(_tableTag : Tag) extends profile.api.Table[LostbidRow](_tableTag, "LostBid") {
    ...
    lazy val bidrequestFk = foreignKey("BidRequest_FK_1", bidrequestid, Bidrequest)(
      r => r.bidrequestid, onUpdate = ForeignKeyAction.NoAction, onDelete = ForeignKeyAction.NoAction)
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(lostbidid), Rep.Some(bidrequestid), reason)).shaped.<>(
      { r => import r._; _1.map(_ => LostbidRow.tupled((_1.get, _2.get, _3))) }, (_ : Any) => throw new Exception(
        "Inserting into ? projection not supported."))
  }
  ...
  class Nobidresponsetype(_tableTag : Tag) extends profile.api.Table[NobidresponsetypeRow](
    _tableTag, "NoBidResponseType") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(nobidresponsetypeid), nobidresponsetype)).shaped.<>(
      { r => import r._; _1.map(_ => NobidresponsetypeRow.tupled((_1.get, _2))) }, (_ : Any) => throw new Exception(
        "Inserting into ? projection not supported."))
  }
   ...
   * @param demandsideplatformid Database column DemandSidePlatformId SqlType(INTEGER) */
  case class PublisherRow(
    publisherid          : Int, publishername : String, publisherwebsite : String, publisheraddress : String,
  ...
  class Publisher(_tableTag : Tag) extends profile.api.Table[PublisherRow](_tableTag, "Publisher") {
    ...
    lazy val demandsideplatformFk = foreignKey("DemandSidePlatform_FK_1", demandsideplatformid, Demandsideplatform)(
      r => r.demandsideplatformid, onUpdate = ForeignKeyAction.Cascade, onDelete = ForeignKeyAction.Cascade)
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(publisherid), Rep.Some(publishername), Rep.Some(publisherwebsite), Rep.Some(
      publisheraddress), Rep.Some(demandsideplatformid))).shaped.<>(
      { r => import r._; _1.map(_ => PublisherRow.tupled((_1.get, _2.get, _3.get, _4.get, _5.get))) },
                                                                                                     (_ : Any) => throw new Exception(
                                                                                                       "Inserting into ? projection not supported."))
  }

  /** GetResult implicit for fetching TransactionRow objects using plain SQL queries */
  implicit def GetResultTransactionRow(
    implicit e0 : GR[Int], e1 : GR[Double], e2 : GR[String]) : GR[TransactionRow] = GR {
    prs =>
      import prs._
  ...
  case class TransactionRow(
    transactionid : Int, advertiseid : Int, spend : Double, impressionid : Int, currency : String)
  ...
  class Transaction(_tableTag : Tag) extends profile.api.Table[TransactionRow](_tableTag, "Transaction") {
    ...
    lazy val impressionFk = foreignKey("Impression_FK_2", impressionid, Impression)(
      r => r.impressionid, onUpdate = ForeignKeyAction.NoAction, onDelete = ForeignKeyAction.NoAction)
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(transactionid), Rep.Some(advertiseid), Rep.Some(spend), Rep.Some(impressionid), Rep.Some(
      currency))).shaped.<>(
      { r => import r._; _1.map(_ => TransactionRow.tupled((_1.get, _2.get, _3.get, _4.get, _5.get))) },
                                                                                                       (_ : Any) => throw new Exception(
                                                                                                         "Inserting into ? projection not supported."))
  }
}
